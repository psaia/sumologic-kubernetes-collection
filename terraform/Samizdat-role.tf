resource "sumologic_role" "Samizdat" {
  ...
  capabilities     = ["viewScheduledViews", "metricsExtraction", "manageFieldExtractionRules", "manageMonitors", "viewPartitions", "manageScheduledViews", "viewFields", "viewFieldExtraction", "createAccessKeys", "manageFields"]
}
