resource "sumologic_role" "MSSP" {
  ...
  capabilities     = ["viewScheduledViews", "manageFieldExtractionRules", "manageMonitors", "viewPartitions", "viewFields", "viewFieldExtraction", "createAccessKeys", "changeDataAccessLevel", "manageFields", "manageDataVolumeFeed"]
}
