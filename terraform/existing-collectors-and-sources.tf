...
resource "sumologic_collector" "dv-test" {
  name        = "dv-test"
  description = "dv-test collector (Managed by Terraform)"
  timezone    = "Etc/UTC"
}
...
resource "sumologic_collector" "nytimes-search-add-es" {
  name        = "nytimes-search-add-es"
  description = "nytimes/search-add-es collector (Managed by Terraform)"
  timezone    = "Etc/UTC"
}

resource "sumologic_collector" "nytimes-search-omnibus-log2es" {
  name        = "nytimes-search-omnibus-log2es"
  description = "nytimes/search-omnibus/log2es collector (Managed by Terraform)"
  timezone    = "Etc/UTC"
}

resource "sumologic_collector" "nytimes-spg-petstore" {
  name        = "nytimes-spg-petstore"
  description = "nytimes/spg-petstore collector (Managed by Terraform)"
  timezone    = "Etc/UTC"
}

resource "sumologic_collector" "nytimes-spg-productservice" {
  name        = "nytimes-spg-productservice"
  description = "nytimes/spg-productservice collector (Managed by Terraform)"
  timezone    = "Etc/UTC"
}

resource "sumologic_collector" "nytm-pubsys-newsgate-ConfigBase1" {
  name        = "nytm-pubsys-newsgate-ConfigBase1"
  description = "nytm/pubsys-newsgate-ConfigBase1 collector (Managed by Terraform)"
  timezone    = "America/New_York"
}

resource "sumologic_collector" "nytm-pubsys-output-scripts" {
  name        = "nytm-pubsys-output-scripts"
  description = "nytm/pubsys-output-scripts collector (Managed by Terraform)"
  timezone    = "America/New_York"
}
...
resource "sumologic_http_source" "dv-test_dv-test-dev" {
  name                         = "dv-test-dev"
  description                  = "dv-test-dev source (Managed by Terraform)"
  category                     = "dv-test-dev"
  collector_id                 = "172514674"
  multiline_processing_enabled = "true"
  timezone                     = "Etc/UTC"
  use_autoline_matching        = "true"
  automatic_date_parsing       = "true"
...
resource "sumologic_http_source" "dv-test_dv-test-prd" {
  name                         = "dv-test-prd"
  description                  = "dv-test-prd source (Managed by Terraform)"
  category                     = "dv-test-prd"
  collector_id                 = "172514674"
  multiline_processing_enabled = "true"
  timezone                     = "Etc/UTC"
  use_autoline_matching        = "true"
...
resource "sumologic_http_source" "dv-test_dv-test-stg" {
  name                         = "dv-test-stg"
  description                  = "dv-test-stg source (Managed by Terraform)"
  category                     = "dv-test-stg"
  collector_id                 = "172514674"
  multiline_processing_enabled = "true"
  timezone                     = "Etc/UTC"
  use_autoline_matching        = "true"
...
resource "sumologic_http_source" "nytimes-search-add-es_nytimes-search-add-es-dev" {
  name                         = "nytimes-search-add-es-dev"
  description                  = "nytimes-search-add-es-dev source (Managed by Terraform)"
  category                     = "nytimes-search-add-es-dev"
  collector_id                 = "173039961"
  multiline_processing_enabled = "true"
  timezone                     = "Etc/UTC"
  use_autoline_matching        = "true"
  automatic_date_parsing       = "true"
...
resource "sumologic_http_source" "nytimes-search-add-es_nytimes-search-add-es-prd" {
  name                         = "nytimes-search-add-es-prd"
  description                  = "nytimes-search-add-es-prd source (Managed by Terraform)"
  category                     = "nytimes-search-add-es-prd"
  collector_id                 = "173039961"
  multiline_processing_enabled = "true"
  timezone                     = "Etc/UTC"
  use_autoline_matching        = "true"
...
resource "sumologic_http_source" "nytimes-search-add-es_nytimes-search-add-es-stg" {
  name                         = "nytimes-search-add-es-stg"
  description                  = "nytimes-search-add-es-stg source (Managed by Terraform)"
  category                     = "nytimes-search-add-es-stg"
  collector_id                 = "173039961"
  multiline_processing_enabled = "true"
  timezone                     = "Etc/UTC"
  use_autoline_matching        = "true"
...
resource "sumologic_http_source" "nytimes-search-omnibus-log2es_nytimes-search-omnibus-log2es-dev" {
  name                         = "nytimes-search-omnibus-log2es-dev"
  description                  = "nytimes-search-omnibus-log2es-dev source (Managed by Terraform)"
  category                     = "nytimes-search-omnibus-log2es-dev"
  collector_id                 = "172859077"
  multiline_processing_enabled = "true"
  timezone                     = "Etc/UTC"
  use_autoline_matching        = "true"
  automatic_date_parsing       = "true"
...
resource "sumologic_http_source" "nytimes-search-omnibus-log2es_nytimes-search-omnibus-log2es-prd" {
  name                         = "nytimes-search-omnibus-log2es-prd"
  description                  = "nytimes-search-omnibus-log2es-prd source (Managed by Terraform)"
  category                     = "nytimes-search-omnibus-log2es-prd"
  collector_id                 = "172859077"
  multiline_processing_enabled = "true"
  timezone                     = "Etc/UTC"
  use_autoline_matching        = "true"
...
resource "sumologic_http_source" "nytimes-search-omnibus-log2es_nytimes-search-omnibus-log2es-stg" {
  name                         = "nytimes-search-omnibus-log2es-stg"
  description                  = "nytimes-search-omnibus-log2es-stg source (Managed by Terraform)"
  category                     = "nytimes-search-omnibus-log2es-stg"
  collector_id                 = "172859077"
  multiline_processing_enabled = "true"
  timezone                     = "Etc/UTC"
  use_autoline_matching        = "true"
...
resource "sumologic_http_source" "nytimes-spg-petstore_nytimes-spg-petstore-dev" {
  name                         = "nytimes-spg-petstore-dev"
  description                  = "nytimes-spg-petstore-dev source (Managed by Terraform)"
  category                     = "nytimes-spg-petstore-dev"
  collector_id                 = "172536899"
  multiline_processing_enabled = "true"
  timezone                     = "Etc/UTC"
  use_autoline_matching        = "true"
  automatic_date_parsing       = "true"
...
resource "sumologic_http_source" "nytimes-spg-petstore_nytimes-spg-petstore-prd" {
  name                         = "nytimes-spg-petstore-prd"
  description                  = "nytimes-spg-petstore-prd source (Managed by Terraform)"
  category                     = "nytimes-spg-petstore-prd"
  collector_id                 = "172536899"
  multiline_processing_enabled = "true"
  timezone                     = "Etc/UTC"
  use_autoline_matching        = "true"
...
resource "sumologic_http_source" "nytimes-spg-petstore_nytimes-spg-petstore-stg" {
  name                         = "nytimes-spg-petstore-stg"
  description                  = "nytimes-spg-petstore-stg source (Managed by Terraform)"
  category                     = "nytimes-spg-petstore-stg"
  collector_id                 = "172536899"
  multiline_processing_enabled = "true"
  timezone                     = "Etc/UTC"
  use_autoline_matching        = "true"
...
resource "sumologic_http_source" "nytimes-spg-productservice_nytimes-spg-productservice-dev" {
  name                         = "nytimes-spg-productservice-dev"
  description                  = "nytimes-spg-productservice-dev source (Managed by Terraform)"
  category                     = "nytimes-spg-productservice-dev"
  collector_id                 = "172542176"
  multiline_processing_enabled = "true"
  timezone                     = "Etc/UTC"
  use_autoline_matching        = "true"
  automatic_date_parsing       = "true"
...
resource "sumologic_http_source" "nytimes-spg-productservice_nytimes-spg-productservice-prd" {
  name                         = "nytimes-spg-productservice-prd"
  description                  = "nytimes-spg-productservice-prd source (Managed by Terraform)"
  category                     = "nytimes-spg-productservice-prd"
  collector_id                 = "172542176"
  multiline_processing_enabled = "true"
  timezone                     = "Etc/UTC"
  use_autoline_matching        = "true"
...
resource "sumologic_http_source" "nytimes-spg-productservice_nytimes-spg-productservice-stg" {
  name                         = "nytimes-spg-productservice-stg"
  description                  = "nytimes-spg-productservice-stg source (Managed by Terraform)"
  category                     = "nytimes-spg-productservice-stg"
  collector_id                 = "172542176"
  multiline_processing_enabled = "true"
  timezone                     = "Etc/UTC"
  use_autoline_matching        = "true"
...
resource "sumologic_http_source" "nytm-pubsys-newsgate-ConfigBase1_nytm-pubsys-newsgate-ConfigBase1-dev" {
  name                         = "nytm-pubsys-newsgate-ConfigBase1-dev"
  description                  = "nytm-pubsys-newsgate-ConfigBase1-dev source (Managed by Terraform)"
  category                     = "nytm-pubsys-newsgate-ConfigBase1-dev"
  collector_id                 = "173015819"
  multiline_processing_enabled = "true"
  timezone                     = "America/New_York"
  use_autoline_matching        = "true"
  automatic_date_parsing       = "true"
...
resource "sumologic_http_source" "nytm-pubsys-newsgate-ConfigBase1_nytm-pubsys-newsgate-ConfigBase1-prd" {
  name                         = "nytm-pubsys-newsgate-ConfigBase1-prd"
  description                  = "nytm-pubsys-newsgate-ConfigBase1-prd source (Managed by Terraform)"
  category                     = "nytm-pubsys-newsgate-ConfigBase1-prd"
  collector_id                 = "173015819"
  multiline_processing_enabled = "true"
  timezone                     = "America/New_York"
  use_autoline_matching        = "true"
...
resource "sumologic_http_source" "nytm-pubsys-newsgate-ConfigBase1_nytm-pubsys-newsgate-ConfigBase1-stg" {
  name                         = "nytm-pubsys-newsgate-ConfigBase1-stg"
  description                  = "nytm-pubsys-newsgate-ConfigBase1-stg source (Managed by Terraform)"
  category                     = "nytm-pubsys-newsgate-ConfigBase1-stg"
  collector_id                 = "173015819"
  multiline_processing_enabled = "true"
  timezone                     = "America/New_York"
  use_autoline_matching        = "true"
...
resource "sumologic_http_source" "nytm-pubsys-output-scripts_nytm-pubsys-output-scripts-dev" {
  name                         = "nytm-pubsys-output-scripts-dev"
  description                  = "nytm-pubsys-output-scripts-dev source (Managed by Terraform)"
  category                     = "nytm-pubsys-output-scripts-dev"
  collector_id                 = "173015820"
  multiline_processing_enabled = "true"
  timezone                     = "America/New_York"
  use_autoline_matching        = "true"
  automatic_date_parsing       = "true"
...
resource "sumologic_http_source" "nytm-pubsys-output-scripts_nytm-pubsys-output-scripts-prd" {
  name                         = "nytm-pubsys-output-scripts-prd"
  description                  = "nytm-pubsys-output-scripts-prd source (Managed by Terraform)"
  category                     = "nytm-pubsys-output-scripts-prd"
  collector_id                 = "173015820"
  multiline_processing_enabled = "true"
  timezone                     = "America/New_York"
  use_autoline_matching        = "true"
...
resource "sumologic_http_source" "nytm-pubsys-output-scripts_nytm-pubsys-output-scripts-stg" {
  name                         = "nytm-pubsys-output-scripts-stg"
  description                  = "nytm-pubsys-output-scripts-stg source (Managed by Terraform)"
  category                     = "nytm-pubsys-output-scripts-stg"
  collector_id                 = "173015820"
  multiline_processing_enabled = "true"
  timezone                     = "America/New_York"
  use_autoline_matching        = "true"
