resource "sumologic_role" "Collector_Managers" {
  ...
  capabilities = ["viewScheduledViews", "manageMonitors", "viewPartitions", "viewFields", "viewFieldExtraction", "createAccessKeys", "changeDataAccessLevel", "manageCollectors", "viewCollectors"]
}
